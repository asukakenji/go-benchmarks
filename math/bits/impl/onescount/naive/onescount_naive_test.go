...
func TestOnesCountAllTable(t *testing.T) {
	onescount.BasicTableTest(t, &onescount.OnesCountFuncs{
		Uint:   naive.OnesCount,
		Uint8:  naive.OnesCount8,
		Uint16: naive.OnesCount16,
		Uint32: naive.OnesCount32,
		Uint64: naive.OnesCount64,
	})
	onescount.TableTest(t, naive.OnesCount)
	onescount.TableTest8(t, naive.OnesCount8)
	onescount.TableTest16(t, naive.OnesCount16)
	onescount.TableTest32(t, naive.OnesCount32)
	onescount.TableTest64(t, naive.OnesCount64)
}
