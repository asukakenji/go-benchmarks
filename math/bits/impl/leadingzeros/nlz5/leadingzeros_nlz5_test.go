...
func TestLeadingZerosAgainstStdlib(t *testing.T) {
	// tcommon.TestAgainstStdlibImplementation(t, nlz5.LeadingZeros)
	tcommon.TestAgainstStdlibImplementation8(t, nlz5.LeadingZeros8)
	tcommon.TestAgainstStdlibImplementation16(t, nlz5.LeadingZeros16)
	tcommon.TestAgainstStdlibImplementation32(t, nlz5.LeadingZeros32)
	tcommon.TestAgainstStdlibImplementation64(t, nlz5.LeadingZeros64)
	// tcommon.TestAgainstStdlibImplementationPtr(t, nlz5.LeadingZerosPtr)
}
