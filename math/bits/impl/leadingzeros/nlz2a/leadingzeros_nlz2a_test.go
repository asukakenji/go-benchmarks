...
func TestLeadingZerosAgainstStdlib(t *testing.T) {
	tcommon.TestAgainstStdlibImplementation(t, nlz2a.LeadingZeros)
	tcommon.TestAgainstStdlibImplementation8(t, nlz2a.LeadingZeros8)
	tcommon.TestAgainstStdlibImplementation16(t, nlz2a.LeadingZeros16)
	tcommon.TestAgainstStdlibImplementation32(t, nlz2a.LeadingZeros32)
	tcommon.TestAgainstStdlibImplementation64(t, nlz2a.LeadingZeros64)
	tcommon.TestAgainstStdlibImplementationPtr(t, nlz2a.LeadingZerosPtr)
}
